...
import 'package:news_app/helper/data_source.dart';
...
class NewsTile extends StatelessWidget {
  ...
  NewsTile({this.imageUrl, this.description, this.title, this.content, @required this.articleUrl});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => ArticleWebView(postUrl: articleUrl, postTitle: title)));
      },
      child: Container(
